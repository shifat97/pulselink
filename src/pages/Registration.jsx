...
const Registration = () => {
  ...
  const handleRegistrationForm = async (e) => {
    ...
    try {
      ...
      toast.error(e.response?.data?.message || e.message || "Registration failed. Please try again.", {
        position: "top-center",
        autoClose: 5000,
      });
    } finally {
      ...
      <div className="w-full max-w-md">
        ...
        <div className="bg-white">
          <form onSubmit={handleRegistrationForm} className="space-y-4">
            ...
            <div>
              ...
              <div className="relative">
                ...
                />
                {errors.fullName && (
                  <div className="absolute -bottom-5 left-0 text-xs text-red-600">{errors.fullName}</div>
                )}
              </div>
            </div>
            ...
            <div className="mt-6">
              ...
              <div className="relative">
                ...
                />
                {errors.email && (
                  <div className="absolute -bottom-5 left-0 text-xs text-red-600">{errors.email}</div>
                )}
              </div>
            </div>
            ...
            <div className="mt-6">
              ...
              <div className="relative">
                ...
                {errors.password && (
                  <div className="absolute -bottom-5 left-0 text-xs text-red-600">{errors.password}</div>
                )}
              </div>
            ...
            <div className="mt-6">
              ...
              <div className="relative">
                ...
                {errors.confirmPassword && (
                  <div className="absolute -bottom-5 left-0 text-xs text-red-600">{errors.confirmPassword}</div>
                )}
            ...
            <div className="mt-6">
              <label className="flex items-start">
                ...
                <span className="ml-2 text-sm text-gray-600">
                  I agree to the{" "}
                  <NavLink to="/terms" className="text-purple-600 hover:text-purple-700 underline">
                    Terms
                  </NavLink>
                  {" "}and{" "}
                  <NavLink to="/privacy" className="text-purple-600 hover:text-purple-700 underline">
                    Privacy Policy
                  </NavLink>
                </span>
              </label>
          ...
          <p className="mt-8 text-center text-sm text-gray-600">
            ...
            <NavLink to="/login" className="font-medium text-purple-600 hover:text-purple-700">
              Sign in here
            </NavLink>
          </p>
        </div>
